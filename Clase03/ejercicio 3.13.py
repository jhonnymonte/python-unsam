    ...
    for i, fila in enumerate(leer_camion, start=1):
        ...
        for i, fila2 in enumerate(leer_precios, start=1):
            if fila['nombre'] in fila2['nombre']:
                informe_cambio.append(round((fila2['precio'] - fila['precio']), 2))

    for n in informe_precios:
        signopesos.append('$'+str(n))

    informe_camion = tuple(zip(informe_nombres, informe_cajones, signopesos, informe_cambio))
    return informe_camion


camion = leer_camion(
    'C:/Users/User2021/Documents/python/unsam/archivos/Data/camion.csv')
precios = leer_precios(
    'C:/Users/User2021/Documents/python/unsam/archivos/Data/precios.csv')
